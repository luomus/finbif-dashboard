...
thematic_shiny(
  font = "Roboto", fg = "#141B15", bg = "#FFFFFF", accent = "#2691D9"
)
...
observe(
  {
    ...
    updateSelectInput(session, "collection_quality", selected = "")
    updateSelectInput(session, "level", selected = "maakunta_name_fi")
  }
) |>
